...
Varsayılan tema koyu olduğu için üç duvar kağıdı da koyu zeminli:
  karan       marka degradesi — turkuazdan maviye ışıma (varsayılan)
  karan-gece  neredeyse düz, en sakin olanı
  karan-duz   tek renk zemin, ortada logo
