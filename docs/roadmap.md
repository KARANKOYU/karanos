...
| 0.7 | H + 76-80 | Oyun Modu, GPU offload, ağ önceliklendirme, cihaz desteği, sanallaştırma. **Kavis Paylaş + Messenger (8 Eyl kararı, kararlar.md 11/12):** sunucusuz-hesapsız-bulutsuz cihazdan cihaza dosya (76) ve pano (77) — LocalSend protokolüyle uyumlu, telefondaki LocalSend Kavis'i görür; ayrı `kavis-messenger` uygulaması yakın mod (78) ve WebRTC + oda kodu ile uzak mod (79); Windows/telefondan cevap için tek dosyalık tarayıcı köprüsü (80). Kavis hesabı, bulut depolama, sunucuda mesaj saklama ve TURN barındırma YOK; buluşma sunucusu yalnız adres değişimini görür | ⏳ |
