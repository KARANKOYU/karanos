...
| 0.3 | C, D | C/Vala panel, görev çubuğu görünümü + sağ tık, pencere yönetimi/snap/Alt+Tab, sanal masaüstleri, takvim + bildirim, görev yöneticisi + küçük araçlar, ekran görüntüsü/kaydı, GTK ortak başlangıç (61), hypervisor uyarı listesi (62) | 🔨 C ✅, D kod ✅ (v0.3-test5 5/5 yeşil) + VM geri bildirim turu ✅ (2 Eyl: sol hizalama vars., W11 bildirim merkezi + ayrı hızlı ayarlar, tepsi araçları USB/Wi-Fi, emoji arama, donmuş kare ekran görüntüsü — flameshot/slop çıktı, splash boşluk karşılığı; panel RSS 36 MB) + boot-sound/EN-varsayılan/gettext işleri ✅ — v0.3-test6 CI + VirtualBox el testi bekliyor |
