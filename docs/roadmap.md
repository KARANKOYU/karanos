...
| 0.3 | C, D | C/Vala panel, görev çubuğu görünümü + sağ tık, pencere yönetimi/snap/Alt+Tab, sanal masaüstleri, takvim + bildirim, görev yöneticisi + küçük araçlar, ekran görüntüsü/kaydı, GTK ortak başlangıç (61), hypervisor uyarı listesi (62) | 🔨 C ✅ (madde 60 hotfix dahil) + açılış deneyimi ✅ (v0.3-test4 5/5 yeşil: retain devri kanıtlı). D ✅ KOD TAMAM (4, 5, 37, 6, 55, 7, 29, 61, 62 — panel 1.2 RSS 34 MB, kavis-tools 25 KB deb) — v0.3-test5 CI + VirtualBox el testi bekliyor |
