...
|---|---|---|---|
| 0.2 | A, A2, B | CI iyileşti, Kavis markası, picom, yeni boot splash + F3, autologin + `/users/karan`, güvenlik sertleştirme, CI test altyapısı | 🔨 A ✅, A2 ✅ (`docs/referans/`), B bekliyor |
