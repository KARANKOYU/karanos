# Karan OS — Claude Code Görev Tanımı (TARİHSEL)

> **NOT (2026-09-01):** Proje **Kavis** olarak yeniden adlandırıldı ve
> güncel yönerge artık `docs/gorev-listesi.md`. Bu dosya Karan OS
> dönemindeki özgün görev tanımıdır; içeriği kasten değiştirilmedi.
> Çelişki durumunda `docs/gorev-listesi.md` geçerlidir.
